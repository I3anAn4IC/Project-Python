...
words = 'муравей бабуин барсук медведь бобр верблюд кошка моллюск кобра пума койот ворона олень собака осел утка ' \
        'орел хорек лиса лягушка коза гусь ястреб ящерица лама моль обезьяна лось мышь мул тритон выдра сова панда ' \
        'попугай голубь питон кролик баран крыса носорог лосось акула змея паук аист лебедь тигр жаба форель индейка ' \
        'черепаха ласка кит волк вомбат зебра'.split()
...
def display_board(font):
    ...
    screen.blit(text_missed_letters, (MIN, 10))
...
def check_letters(letter, font):
    ...
    screen.blit(text_letter, coordinates_text_letter)
